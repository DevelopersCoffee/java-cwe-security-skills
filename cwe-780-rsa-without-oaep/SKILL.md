---
name: cwe-780-rsa-without-oaep
description: Use this skill when you need to remediate CWE-780 (RSA Without OAEP Padding) vulnerabilities in Java code. Triggers on SAST findings, security reviews, or when fixing rsa without oaep padding issues.
version: 1.0.0
license: MIT
tags:
- security
