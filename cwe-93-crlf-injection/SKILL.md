...
description: Use this skill when you need to remediate CWE-93 (CRLF Injection) vulnerabilities in Java code. Triggers on SAST findings, security reviews, or when fixing crlf injection issues.
version: 1.0.0
license: MIT
tags:
- security
