---
name: cwe-776-xml-entity-expansion
description: Use this skill when you need to remediate CWE-776 (XML Entity Expansion (Billion Laughs)) vulnerabilities in Java code. Triggers on SAST findings, security reviews, or when fixing xml entity expansion (billion laughs) issues.
version: 1.0.0
license: MIT
tags:
- security
